# Run with: shiny run --reload --launch-browser Python/shescores-querychat-app-express.py
...
_ = load_dotenv()  # Loads key from the .env file
    ...
    with ui.card(min_height="600px"):
        ...
        def results_table():
            ...
            display_df = display_df.drop(
                columns=["country_flag_home", "country_flag_away"]
            )
